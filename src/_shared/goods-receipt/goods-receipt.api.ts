...
export class GoodsReceiptApi {
  ...
  public post_GoodsReceipt(data: GoodsReceipt, dataApi: string = '') {
    ...
    this.http
      .post(this.http.getAPI('Goodsreceipt') + '/' + dataApi, data, headers)
      .subscribe(
        (result) => {
  ...
  public put_GoodsReceipt(data: GoodsReceipt, dataApi: string = '') {
    ...
    this.http
      .put(this.http.getAPI('Goodsreceipt') + '/' + dataApi, data, headers)
      .subscribe(
        (result) => {
  ...
  public get_GoodsReceiptBy(apitype: string) {
    const output = new Promise((resolve) => {
      this.http
        .get(this.http.getAPI('Goodsreceipt') + '/' + apitype, {
          responseType: 'text',
        })
        .subscribe(
          (result) => {
